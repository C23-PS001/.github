...
🌈 This github organization contains four repositories for each learning path but we made 2 repositories for machine learning because we deployed two different APIs for machine learning models which is OCR and Siamese
